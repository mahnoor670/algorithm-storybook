...
export default function App() {
  ...
  const restart = () => {
    ...
    setMessage("Help the Illini squirrel find the golden acorn hidden on the Quad!");
    fetch("http://localhost:8080/start")
      .then(res => res.json())
      .then(data => setSecret(data.secret));
  };
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "Georgia, serif", overflow: "hidden", position: "relative" }}>
        ...
        {/* New game button */}
        <div style={{ position: "fixed", bottom: "16px", left: 0, right: 0, textAlign: "center", zIndex: 10 }}>
